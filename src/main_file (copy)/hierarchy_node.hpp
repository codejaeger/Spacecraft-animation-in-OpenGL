...
namespace csX75	 { 
	...
	struct HNode {
		//glm::vec4 * vertices;
		//glm::vec4 * colors;
		GLfloat tx,ty,tz,rx,ry,rz,revcl;
	  ...
	  public:
		HNode (HNode*, GLuint, GLuint, GLuint, glm::vec4*,  glm::vec4*, glm::vec3*, std::size_t, std::size_t, std::size_t, bool);
