...
namespace csX75	 { 
	...
	class HNode {
	  ...
	  public:
		HNode (HNode*, GLuint,GLuint,GLuint, glm::vec4*,  glm::vec3*,  glm::vec4*, std::size_t, std::size_t, std::size_t);
		...
		void dec_ry();
		void dec_rz();
		void change_rot(GLfloat,GLfloat,GLfloat);
	};
